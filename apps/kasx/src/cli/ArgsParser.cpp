...
KasX::App::CLI::CompiledArgument KasX::App::CLI::ArgsParser::ParseArguments(int argc,
  ...
  for (int i = 1; i < argc; ++i) {
    ...
    if (arg == "-v" || arg == "--version") {
      ...
      ret.execution_type = static_cast<int>(KasX::App::Core::EXECUTION_TYPE::PRINT_VERSION);
    } else {
      if (i == 1) {
        ...
        ret.execution_type = static_cast<int>(KasX::App::Core::EXECUTION_TYPE::COMPILE_FILE);
        ret.filePath = arg;
      } else {
