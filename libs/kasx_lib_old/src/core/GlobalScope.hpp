...
class GlobalScope : public Scope {
 ...
 private:
  ...
  /**
   * @brief This function will remove the default character declaration as a type since a custom character type is defined in the
   * domain code.
   */
  void handleCustomCharacterDefinition();
};
}  // namespace KasX::Compiler::Core
