...
public class KasXLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"LINE_COMMENT", "BLOCK_COMMENT", "WS", "TYPE_DEFINITION_KEYWORD", "ENTITY_DEFINITION_KEYWORD", 
			"FLUENT_DEFINITION_KEYWORD", "ACTION_DEFINITION_KEYWORD", "TRIGGER_DEFINITION_KEYWORD", 
			"KEYWORD_BELIEVES", "UTILITY_DEFINITION_KEYWORD", "EXISTENTIAL_QUANTIFICATION_KEYWORD", 
			"CONDITIONAL_EFFECT_KEYWORD", "UNIVERSAL_QUANTIFICATION_KEYWORD", "PRODUCT_KEYWORD", 
			"SUM_KEYWORD", "GOAL_KEYWORD", "NUMBER_KEYWORD", "BOOLEAN_KEYWORD", "PRECONDITION_KEYWORD", 
			"EFFECT_KEYWORD", "CONSENTING_KEYWORD", "OBSERVING_KEYWORD", "CONDITIONAL_FIRST_BRANCH_KEYWORD", 
			"CONDITIONAL_LAST_BRANCH_KEYWORD", "CONDITIONAL_MIDDLE_BRANCH_KEYWORD", 
			"NUMBER", "IDENTIFIER", "UNKNOWN_KEYWORD", "FALSE_KEYWORD", "TRUE_KEYWORD", 
			"NULL_CLAUSE_KEYWORD", "EQUAL_TO_KEYWORD", "NOT_EQUAL_TO_KEYWORD", "GREATER_THAN_OR_EQUAL_TO_KEYWORD", 
			"LESS_THAN_OR_EQUAL_TO_KEYWORD", "ASSIGNMENT_KEYWORD", "NEGATION_KEYWORD", 
			"DISJUNCTION_KEYWORD", "CONJUNCTION_KEYWORD", "GREATER_THAN_KEYWORD", 
			"LESS_THAN_KEYWORD", "MULTIPLICATION_KEYWORD", "DIVISION_KEYWORD", "ADDITION_KEYWORD", 
			"SUBTRACTION_KEYWORD", "OPEN_BRACKET", "CLOSE_BRACKET", "START_CUR_BRACES", 
			"END_CUR_BRACES", "DEFINITION_SEPARATOR", "COLON", "COMMA", "ERROR_CHAR"
		};
	}
	...
	public KasXLexer(CharStream input) {
		super(input);
